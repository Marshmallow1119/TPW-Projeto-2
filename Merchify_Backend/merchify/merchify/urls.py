...
urlpatterns = [
    ...
    path('ws/favorites/<str:category>/', views.favorites, name='favorites'),
    path('ws/favorites/<int:product_id>/', views.product_favorites, name='product_favorite'),
    path('ws/favorites/<int:artist_id>/', views.artist_favorites, name='artist_favorite'),
