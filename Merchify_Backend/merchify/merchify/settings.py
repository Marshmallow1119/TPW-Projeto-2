...
SECRET_KEY = 'django-insecure-h4^-%nfeai9iafj)gi16dq3-c$h+$g@6h)bl9geb+3)8p!cyj+'
...
REST_FRAMEWORK = {
    'DEFAULT_PERMISSION_CLASSES': [
        'rest_framework.permissions.AllowAny',  # Apenas uma vez
    ],
    'DEFAULT_AUTHENTICATION_CLASSES': (
        'rest_framework_simplejwt.authentication.JWTAuthentication',
    ),
...
# CORS CONFIG
CORS_ALLOW_ALL_ORIGINS = False  # Defina como False para usar apenas CORS_ALLOWED_ORIGINS
